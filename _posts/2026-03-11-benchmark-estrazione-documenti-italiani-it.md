...
<article class="pt-36 pb-20 px-6">
    <div class="max-w-3xl mx-auto">
        ...
        <div class="prose prose-invert prose-lg max-w-none text-gray-300 leading-relaxed space-y-6">
            ...
            <p>Se vuoi verificare questi risultati sul tuo parco documentale specifico nell&rsquo;ambito di un proof-of-concept, <a href="/it/pricing/" class="text-brand-tealLight hover:underline">contattaci</a> &mdash; conduciamo pilot strutturati con i potenziali clienti sui loro documenti reali, sotto NDA, sulla loro infrastruttura.</p>
        ...
        <div class="mt-12 rounded-2xl p-8 text-center" style="background: linear-gradient(135deg, rgba(13,148,136,0.15) 0%, rgba(16,185,129,0.10) 100%); border: 1px solid rgba(13,148,136,0.3);">
            ...
            <div class="flex flex-wrap justify-center gap-3">
                <a href="/it/pricing/" class="bg-brand-teal text-white font-bold px-6 py-3 rounded-xl hover:bg-brand-teal/80 transition-colors">Richiedi un Pilot &rarr;</a>
